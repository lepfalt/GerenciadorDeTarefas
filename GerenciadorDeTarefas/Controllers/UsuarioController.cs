...
namespace GerenciadorDeTarefas.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nome,Email,Permissao,Senha,Codigo")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Nome,Email,Permissao,Senha,Codigo")] Usuario usuario)
        {
